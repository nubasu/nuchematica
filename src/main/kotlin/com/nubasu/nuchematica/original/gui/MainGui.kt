...
public class MainGui: Gui(Minecraft.getInstance(), Minecraft.getInstance().itemRenderer) {
    private val mc: Minecraft = Minecraft.getInstance()

    @SubscribeEvent
    public fun onPostRenderGuiOverlayEvent(event: RenderGuiOverlayEvent.Post) { // 画面が表示されたとき
